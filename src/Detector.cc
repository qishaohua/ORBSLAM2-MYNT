...
// 这里的 两个文件地址需要传入
  ...
  //det_net_ptr->load_param("/home/qsh/Project/Slam/src/ORB_SLAM2-MYNT/Thirdparty/ncnn/model/mobilenetv2_ssdlite_voc.param");
  //det_net_ptr->load_model("/home/qsh/Project/Slam/src/ORB_SLAM2-MYNT/Thirdparty/ncnn/model/mobilenetv2_ssdlite_voc.bin");
    det_net_ptr->load_param("/home/qsh/Project/Slam/src/ORB_SLAM2-MYNT/Thirdparty/ncnn/my_model/mobilenet-yolov3-my.param");
    det_net_ptr->load_model("/home/qsh/Project/Slam/src/ORB_SLAM2-MYNT/Thirdparty/ncnn/my_model/mobilenet-yolov3-my.bin");
    //det_net_ptr->load_param("/home/qsh/Project/Slam/src/ORB_SLAM2-MYNT/Thirdparty/ncnn/model/mobilenetv2ssd_qsh.param");
    //det_net_ptr->load_model("/home/qsh/Project/Slam/src/ORB_SLAM2-MYNT/Thirdparty/ncnn/model/new2.bin");
...
*/
static const char* class_names[] = {"background",
  "mouse", "monitor", "cup", "chair", "fan", "phone",
  "box", "keyboard", "person", "bag"};
    ...
    for (int i=0; i<out.h; i++)
    {
        ...
        if(object.prob < 0.5 || object.rect.width == 0 || object.rect.height == 0) continue;
